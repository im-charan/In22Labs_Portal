  ...
  },
  {
    ...
    children: [
     { path: "/", element: <ProtectedRoutes element ={<Navigate to='/dashboard'/>} /> },
      ...
      // { path: '*', element: <Navigate to="/auth/404" /> },
      { path: "/dashboard/:orgId/:dashboardId", element: <ProtectedRoutes element={<Pbpage />} /> },
...
//       { path: "/dashboard/:orgId", exact: true, element: <Dashboard /> },
//       { path: "/sample-page", exact: true, element: <SamplePage /> },
//       { path: "/icons", exact: true, element: <Icons /> },
//       { path: "/dashboard/:orgId/:dashboardId", element: <Pbpage /> },
...
//       { path: 'dashboard', exact: true, element: <ListDashboards /> },
...
//       { path: 'dashboard/:id', exact: true, element: <Adminpbpage /> },
//     ],
//   }
// ];
